...
**18.** Type name mentions inside `//` single-line comments, `///` doc comments, or `/* */` block comments are not counted as real references. The corpus is stripped of all comments before reference scanning.
